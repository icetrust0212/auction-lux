        ...
        <Row className={"auction-item p-3 " }>
            ...
            <Col md={3} className={"auction-detail d-flex"+ (item.state === AuctionState.DONE ? ' gray' : '')}>
                <div className="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <span className="price size-medium color-light text-start">
                ...
                <div className="d-flex flex-column text-start h-100">
                    {
                        ...
                        item.state === AuctionState.DONE && (
                            <>
                                <label htmlFor="" className="color-secondary header size-small text-start">Auction Ended: </label>
                                <h3 className="size-large color-dark">
                    ...
                    }
                    {
                        ...
                        item.state === AuctionState.DONE && (
                            <div className={"media mt-2 d-flex" + (item.state === AuctionState.DONE ? ' gray' : '')}>
