  ...
  return (
    <>
      ...
      <div className="upcomming-auction-second">
        <h2 className="title color-dark size-extremely-large w-100 text-center m-5">Upcoming Auctions</h2>
        <Carosuel visibleControl={false} itemClass="carousel-item-class">
            {
